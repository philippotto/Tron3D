...
PostProcessing::PostProcessing(osg::ref_ptr<osg::Group> rootNode, int width, int height, OculusDevice *od)
:m_root(rootNode), m_sceneNode(new osg::Group()), m_width(width), m_height(height), m_device(od)
{
	AbstractView();

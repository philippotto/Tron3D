...
void main()
{
	...
	float bending_blend = bendingFactor * clamp(smoothstep(0.0, 0.07, xy_dist  * xy_dist), 0.0, 0.9);
	...
	reflectionTextureColor = mix(reflectionTextureColor, vec4(1.0), bending_blend);

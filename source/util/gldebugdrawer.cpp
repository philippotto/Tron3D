...
void GLDebugDrawer::drawLine(const btVector3& from, const btVector3& to, const btVector3& color)
{
	...
	osg::Vec3 osgFrom = osg::Vec3(from.x(), from.y(), from.z());
	osg::Vec3 osgTo = osg::Vec3(to.x(), to.y(), to.z());
	...
	osg::Vec4 c = osg::Vec4(color.x(), color.y(), color.z(), 1.);
...
void GLDebugDrawer::drawTriangle(const btVector3& a, const btVector3& b, const btVector3& c, const btVector3& color, btScalar alpha)
{
	...
	_triVerts->push_back(asOsgVec3(a));
	_triVerts->push_back(asOsgVec3(b));
	_triVerts->push_back(asOsgVec3(c));

	osg::Vec4 c4 = asOsgVec4(color, alpha);
